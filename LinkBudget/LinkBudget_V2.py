...
if __name__ == "__main__":
    excel_r = pd.read_excel("GroundStation.xlsx", usecols=['NOM', 'Diametre (m)']).dropna().reset_index()
    excel_e = pd.read_excel("Equipement Communication embarqué.xlsx", sheet_name='Microstrip Antenna', 
