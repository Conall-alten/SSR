...
df=pd.read_excel(r"C:\Users\gblavet\Desktop\Imput simu maintien.xlsx")      #Récupération des données d'entrée
...
df.to_excel(r"C:\Users\gblavet\Desktop\Résultats simu maintien.xlsx","Résultats",index=False)   #Export des résultats