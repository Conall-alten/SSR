...
#%% Importing Databases
cameras = pd.read_csv("../input/cameras/cameras.csv")
e_thrusters = pd.read_csv("../input/thrusters/Electric_Thrusters.csv", encoding= 'unicode_escape')
he_thrusters = pd.read_csv("../input/thrusters/Hall_Effect_Thrusters.csv")
w_thrusters = pd.read_csv("../input/thrusters/water_thrusters.csv")
mo_thrusters = pd.read_csv("../input/thrusters/Monopropellant_thrusters.csv")
RW = pd.read_csv("../input/reaction_wheel/Reaction_Wheels.csv")
ST = pd.read_csv("../input/star_trackers/Star_Trackers.csv")
CPUs = pd.read_csv("../input/obdh/OBDH.csv")
db_GNC = pd.read_csv("../input/navigation/GNC_modules.csv", encoding = 'unicode_escape')
Transmitters = pd.read_csv("../input/transmitters/Transmitters.csv")
Gyroscopes = pd.read_csv("../input/gyroscopes/Gyroscopes.csv")
dbSS = pd.read_csv("../input/sunsensors/Sunsensors.csv")
tanks = pd.read_csv("../input/tanks/tanks.csv")
...
def m_AOCS(alt, res, total_mass, fauche):
    ...
    dbST = pd.read_csv("../input/star_trackers/Star_Trackers.csv")
    k=0
    j = 1
    mass = 0
