...
import test_GUI_esteban as mouk
...
#%% Paramétrage
outile = mouk.Interface()

path_user = outile.path # Chemin de la base de données

# Paramètres de la constellation 1

orbit1 = outile.type_orb # Type d'orbite (RCO, SSO, CITROUILLE)
#orbit1 = "\CITROUILLE"
#orbit1 = "\SSO"
sat1 = outile.sat # Nombre de satellites par plan (~2)
plan1 = outile.plan # Nombre de plans (~4 - ~12)
inc1 = outile.inc # Inclinaison des orbites (47, 51..., couplées 48_50, 47_49_50, ou
               # 0 si SSO) ou latitude du point focal pour une constellation 
               # citrouille
alt1 = outile.alt # Altitude (150 - 500 km)
res1 = outile.res   # Les fichiers apparaissent dans l'ordre alphabétique (ex : 
...
orbit2 = outile.type_orb2 # Si SSO est seule
sat2 = outile.sat2 # Nombre de satellites par plan
plan2 = outile.plan2 # Nombre de plans
#inc2 = "50" # Inclinaison des orbites
inc2 = outile.inc2
alt2 = outile.alt2 # Altitude (150 - 500 km)
res2 = outile.res2
...
folder1 = outile.folder1
folder2 = outile.folder2
folder3 = outile.folder3

path = path_user+folder1+folder2
print(path+folder3+name+".csv")
print(outile.name)
...
# de coordonnées (lat, long)
    ...
    N = int(sat1)*int(plan1)#+int(sat2)*int(plan2)
